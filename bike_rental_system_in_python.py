...
class BikeRental:
    ...
    def rentBikeOnHourlyBasis(self, n):
        ...
        # do not rent bike is stock is less than requested bikes
            ...
            print(
                "Sorry! We have currently {} bikes available to rent.".format(
                    self.stock
                )
            )
            return None
        ...
        # rent the bikes
            ...
            print(
                "You have rented a {} bike(s) on hourly basis today at {} hours.".format(
                    n, now.hour
                )
            )
    ...
    def rentBikeOnDailyBasis(self, n):
        ...
        if n <= 0:
            ...
            now = datetime.datetime.now()
            print(
                "You have rented {} bike(s) on daily basis today at {} hours.".format(
                    n, now.hour
                )
            )
    ...
    def rentBikeOnWeeklyBasis(self, n):
        ...
        if n <= 0:
            ...
            now = datetime.datetime.now()
            print(
                "You have rented {} bike(s) on weekly basis today at {} hours.".format(
                    n, now.hour
                )
            )
